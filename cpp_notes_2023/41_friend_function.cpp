...
// Member functions are functions inside a class that can access its private members (variables and functions).
	void get(){
        ...
        // Declare displayCar as a friend function
// They are not part of the class but are given permission to access the class's private stuff.
    friend void displayCar(const car &obj);
};

// Friend function to display car details
