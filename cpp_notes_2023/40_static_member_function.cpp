// static members functions are often used for operations that are not dependent on the state of a particular instance but are related to the class as a whole.
