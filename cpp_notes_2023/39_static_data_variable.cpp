//static data variable //static memeber variable  //static class data -->same

// static data variable:refers to variable that is declared static within the class.
// a static data variable is a variable that belongs to a class rather than as instance of that class.
...
class team{
    ...
    public:
    // Constructor is used for creating instances and can perform other tasks,
    // but it should not initialize static members.
        void print(){
            cout<<squadMembers;
        } 
